/* eslint-disable -- this file no require lint */
 ...
 * @returns color
 */
export function RGB_Linear_Blend(p,c0,c1){
 ...
 * @returns color
 */
export function RGB_Linear_Shade(p,c0){
 ...
 * @returns color
 */
export function RGB_Log_Shade(p,c0){
 ...
 * @returns color
 */
export function RGB_Alpha_Shade(p, color) {
  var i = parseInt
  var n = p < 0
